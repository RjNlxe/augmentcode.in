export const angularIonicFirebaseFirestoreRules = [
  {
    ...
    title: "Angular Ionic Firebase Firestore Augment Rules",
    slug: "angular-ionic-firebase-firestore-augment-rules",
    ...
    - Use Firebase query pagination for data pagination.
