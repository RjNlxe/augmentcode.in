export const laravelRules = [
  {
    tags: ["Laravel", "PHP"],
    title: "Laravel PHP Augment Rules",
    slug: "laravel-php-augment-rules",
    libs: [],
    content: `
  ...
  {
    title:
      "Comprehensive Laravel PHP Augment Rules: Best Practices and Key Principles.",
    tags: ["Laravel", "PHP", "Franework"],
    libs: [],
    slug: "laravel-augment-rules",
    content: `
  You are an expert in Laravel, PHP, and related web development technologies.
  ...
  {
    title:
      "Tall Stack Augment Rules with Laravel, Livewire, Alpine.js, TailwindCSS, and DaisyUI",
    tags: ["Laravel", "PHP", "Livewire", "Alpine.js", "TailwindCSS", "DaisyUI"],
    libs: ["laravel", "tailwindcss", "livewire", "alpinejs", "daisyui"],
    slug: "tallstack-augment-rules",
    content: `
  ...
  {
    title: "Minimal Laravel PHP Augment Rules",
    tags: ["Laravel", "PHP"],
    libs: ["laravel"],
    slug: "minimal-laravel-php-augment-rules",
    content: `
