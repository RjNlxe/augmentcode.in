export const swiftuiRules = [
  {
    tags: ["SwiftUI", "Swift"],
    title: "SwiftUI Swift Augment Rules",
    libs: [],
    slug: "swiftui-swift-augment-rules",
    content: `
  # Original instructions: https://forum.augment.com/t/share-your-rules-for-ai/2377/3
  # Original original instructions: [Reference removed]
  ...
  },
  {
    ...
    title: "SwiftUI COT Developer Augment Rules",
    libs: [],
    slug: "swiftui-COT-developer-augment-rules",
    content: `
  # CONTEXT
  ...
  {
    tags: ["SwiftUI", "Swift"],
    title: "SwiftUI Swift Simple Augment Rules",
    libs: [],
    slug: "swiftui-swift-simple-developer-augment-rules",
    content: `
