export const wordpressRules = [
  {
    tags: ["WordPress", "PHP"],
    title: "WordPress PHP Augment Rules",
    slug: "wordpress-php-augment-rules",
    libs: [],
    content: `
  ...
  {
    tags: ["WordPress", "PHP"],
    title: "Comprehensive Wordpress PHP Augment Rules: Best Practices and Key Principles.",
    slug: "wordpress-development-best-practices-augment-rules",
    content: `
    You are an expert in WordPress, PHP, and related web development technologies.
